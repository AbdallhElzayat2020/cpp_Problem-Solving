// cpp_Problem Solving.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
//{
//
//	// print new line with std::endl
//	cout << "abdallh" << std::endl;
